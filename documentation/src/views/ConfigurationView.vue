    ...
    <DefaultLayout>
        <div>
            ...
            <div class="bg-gray-200 p-4 rounded-md mb-6">
                ...
                <highlightjs :code="cliConfigExample" language="yaml" />
            ...
            <div class="bg-blue-100 p-4 rounded-md mb-6">
                ...
                <highlightjs :code="elementsSection" language="yaml" />
                <p class="mb-4">
                ...
                <highlightjs :code="pagesSection" language="yaml" />
                <h2 class="text-2xl font-semibold mb-4">Test Configuration Example</h2>
                <highlightjs :code="testConfigExample" language="yaml" />
            </div>
        </div>
