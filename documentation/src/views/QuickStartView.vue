    ...
    <DefaultLayout>
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <ul class="list-disc list-inside ml-2">
                    <li><router-link :to="{ name: routeNames.config }" target="_blank" class="underline">etoolse
                            Configuration</router-link></li>
                    <li><router-link :to="{ name: routeNames.sentences }" target="_blank" class="underline">etoolse
